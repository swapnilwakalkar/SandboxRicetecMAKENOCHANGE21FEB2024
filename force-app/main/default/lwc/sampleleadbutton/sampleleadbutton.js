...
export default class Sampleleadbutton extends NavigationMixin(LightningElement) {
  ...
  async createAccount() {
    try {
      const account = await submitAccount({ LeadCompany: this.accountName, LeadMobile1: this.accountMobile1, 
        ...
        AccountBillingTerritory: this.accountBillingTerritory, AccountBillingCountry: this.accountBillingCountry,
